...
const u8 gText_MysteryEvent[] = _("MYSTERY EVENT");
...
const u8 gJPText_DecideStop[] = _("{A_BUTTON}OK {B_BUTTON}EXIT");
...
const u8 gJPText_UnableConnectWithEReader[] = _("Unable to connect to the e-Reader.");
...
const u8 gJPText_NewTrainerHasComeToSevii[] = _("A new Trainer has arrived on Seven\nIsland.");
